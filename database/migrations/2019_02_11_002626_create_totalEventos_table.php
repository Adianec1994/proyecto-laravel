...
class CreateTotaleventosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('totalEventos')) {
            Schema::create('totalEventos', function (Blueprint $table) {
                $table->engine = 'InnoDB';
                $table->increments('idtotalEventos');
    ...
    {
        Schema::dropIfExists('totalEventos');
    }
}
